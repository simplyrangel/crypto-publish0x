...
# target APY:
current_rebase_rate = 0.003421
coeff = np.polyfit(
    [0,last_e0_rebase],
    [current_rebase_rate,0.001587],
    deg=1, 
    )
...
# exceeds 10 million.
# -------------------------------------------------------
apy_bounds = [5.0,10.0] #500 to 1000 percent APY 
